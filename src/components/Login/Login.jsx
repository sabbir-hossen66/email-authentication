    ...
    <div className="w-full max-w-md mx-auto p-8 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800">
      ...
      <form onSubmit={handleLogin} className="space-y-6">
        <div className="space-y-1 text-sm">
          <label type="username" className="block dark:text-gray-600">Username</label>
          <input type="text" name="email" id="email" placeholder="Username" className="w-full px-4 py-3 rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 focus:dark:border-default-600" />
        </div>
        <div className="space-y-1 text-sm">
          <label type="password" className="block dark:text-gray-600">Password</label>
        ...
        <button className="block w-full p-3 text-center rounded-sm  dark:bg-default-600">Sign in</button>
      </form>
